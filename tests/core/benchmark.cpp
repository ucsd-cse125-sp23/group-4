...
TEST_CASE("Single Object Multi Collider", "[benchmark]") {
	...
	for (int i = 0; i < 20; i++)
		for (int j = 0; j < 20; j++)
			for (int k = 0; k < 20; k++)
				vertices.push_back(vec3f((i - 10.0) / 10, (j - 10.0) / 10, (k - 10.0) / 10));
		...
		for(int x = 0; x < 10; x++)
			for(int z = 0; z < 10; z++)
			{
				for (int i = 0; i < 10; i++)
					for (int j = 0; j < 10; j++)
						for (int k = 0; k < 10; k++)
							vertices.push_back(vec3f((i - 5.0) / 5 + (x - 5), (j - 5.0) / 5, (k - 5.0) / 5 + (z - 5)));
				environment->addConvex(vertices);
				vertices.clear();
			}
		...
		for (int x = 0; x < 40; x++)
			for (int z = 0; z < 40; z++)
			{
				for (int i = 0; i < 10; i++)
					for (int j = 0; j < 10; j++)
						for (int k = 0; k < 10; k++)
							vertices.push_back(vec3f((i - 5.0) / 5 + (x - 20), (j - 5.0) / 5, (k - 5.0) / 5 + (z - 20)));
				environment->addConvex(vertices);
				vertices.clear();
			}
		...
		for (int x = 0; x < 10; x++)
			for (int z = 0; z < 10; z++)
			{
				for (int i = 0; i < 20; i++)
					for (int j = 0; j < 20; j++)
						for (int k = 0; k < 20; k++)
							vertices.push_back(vec3f((i - 10.0) / 10 + (x - 5), (j - 10.0) / 10, (k - 10.0) / 10 + (z - 5)));
				environment->addConvex(vertices);
				vertices.clear();
			}
		...
		for (int x = 0; x < 40; x++)
			for (int z = 0; z < 40; z++)
			{
				for (int i = 0; i < 20; i++)
					for (int j = 0; j < 20; j++)
						for (int k = 0; k < 20; k++)
							vertices.push_back(vec3f((i - 10.0) / 10 + (x - 20), (j - 10.0) / 10, (k - 10.0) / 10 + (z - 20)));
				environment->addConvex(vertices);
				vertices.clear();
			}
