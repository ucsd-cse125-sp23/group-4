...
template <typename T>
inline bool operator==(const TVector4<T>& v0, const TVector4<T>& v1) {
...
inline TVector3<T> cross(const TVector3<T>& v0, const TVector3<T>& v1) {
  return TVector3<T>{v0[1] * v1[2] - v0[2] * v1[1],
                     v0[2] * v1[0] - v0[0] * v1[2],
                     v0[0] * v1[1] - v0[1] * v1[0]};
}
template <typename T>
...
inline TVector3<T> min(const TVector3<T>& v0, const TVector3<T>& v1) {
  return TVector3<T>{std::min(v0.x, v1.x), std::min(v0.y, v1.y),
                     std::min(v0.z, v1.z)};
}
template <typename T>
inline TVector3<T> max(const TVector3<T>& v0, const TVector3<T>& v1) {
  return TVector3<T>{std::max(v0.x, v1.x), std::max(v0.y, v1.y),
                     std::max(v0.z, v1.z)};
}
...
template <typename T>
inline TVector4<T> operator*(const TVector4<T>& v0, const TVector4<T>& v1) {
  return TVector4<T>(v0[0] * v1[0], v0[1] * v1[1], v0[2] * v1[2],
                     v0[3] * v1[3]);
}
template <typename T>
inline TVector4<T>& operator*=(TVector4<T>& v, const T& s) {
...
inline TVector4<T> min(const TVector4<T>& v0, const TVector4<T>& v1) {
  return TVector4<T>{std::min(v0.x, v1.x), std::min(v0.y, v1.y),
                     std::min(v0.z, v1.z), std::min(v0.w, v1.w)};
}
template <typename T>
inline TVector4<T> max(const TVector4<T>& v0, const TVector4<T>& v1) {
  return TVector4<T>{std::max(v0.x, v1.x), std::max(v0.y, v1.y),
                     std::max(v0.z, v1.z), std::max(v0.w, v1.w)};
}
